...
func NewProjectServiceServer(usecase usecases.ProjectUsecaseInterfaces, usraddr, compaddr, topic string, producer sarama.SyncProducer) *ProjectServiceServer {
